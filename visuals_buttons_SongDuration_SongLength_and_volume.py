...
mp3.maxsize(500, 450) # Setting Max Size Above Which Our MP3 PLAYER can't be stretched out (width, height)
mp3.minsize(500, 15) # Setting Min Size Below Which Our MP3 PLAYER can't be stretched in (width, height)
