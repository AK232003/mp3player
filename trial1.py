...
#mp3.iconbitmap("icons/MP3.png") # Setting icon for MP3 PLAYER
...
forward_image = tk.PhotoImage(file="icons/resized/fast-forward-button.png")
back_image = tk.PhotoImage(file="icons/resized/rewind.png")
stop_image = tk.PhotoImage(file="icons/resized/stop-button.png")
pause_image = tk.PhotoImage(file="icons/resized/pause_button.png")
play_image = tk.PhotoImage(file="icons/resized/play-button.png")
